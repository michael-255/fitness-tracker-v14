...
const { descriptionModel, descriptionInputRef } = useInputInject(FieldName.DESCRIPTION)
const maxLength = 500
</script>
...
<template>
  <QInput
    ...
    label="Description"
    :rules="[(val: string) => isTextValid(val) || 'Description is limited to 500 characters']"
    :maxlength="maxLength"
